    ...
    async function getLocation(x){
            ...
            try{
                ...
                infoDiv.innerHTML = `<p>The Address to this park is ${park.location}Located in the Borough of ${borough}.It has ${park.acres} Acres of land and This park was acquired on ${park.acquisitiondate.slice(0,10)}.Yyou can find out more about this park by clicking this <a href = '${park.url}' style = 'color: black;'> link </a> </p>`
